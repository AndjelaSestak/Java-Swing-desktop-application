...
public class DlgHexagon extends JDialog{
	...
	public void setHOk(boolean isHOk) {
		this.isHOk = isHOk;
	}
	...
	public void setHexagon(HexagonAdapter hexagon) {
		txtCoordinateX.setText(" " + hexagon.getX());
		txtCoordinateY.setText(" " + hexagon.getY());
		txtRadius.setText(" " + hexagon.getRadius());
		btnBorder.setBackground(hexagon.getColor());
		btnInner.setBackground(hexagon.getInnerColor());
	}
